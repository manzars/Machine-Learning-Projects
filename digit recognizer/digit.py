...
classifier = RandomForestClassifier(n_estimators = 300, n_jobs = 3, criterion = "gini", random_state = 0)
...
def check_prediction(num):
    ...
    print("Predicted Value is %s" %(classifier.predict(X_test[num].reshape(1, -1))))
